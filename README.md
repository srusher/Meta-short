...
See [`nextflow.config`](nextflow.config) for a complete list of parameters
...
metashort was originally written by rtq0.
...
<!-- If you use metashort for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
