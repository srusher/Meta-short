process NONPAREIL_NONPAREILCURVESR {
    ...
    tuple val(meta), path(pngs) // not actually using this input channel - this is just to prevent this module from processing npos from reads that did not generate a curve or errored out during the processs
    ...
    path("*.json")                 , emit: mqc_json, optional: true
